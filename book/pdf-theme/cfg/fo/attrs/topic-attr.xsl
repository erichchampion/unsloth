...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:attribute-set name="note__table__note" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__notice" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__tip" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__fastpath" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__restriction" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__important" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__remember" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__attention" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__caution" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__danger" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__warning" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__trouble" use-attribute-sets="note__table"/>
    <xsl:attribute-set name="note__table__other" use-attribute-sets="note__table"/>
    ...
    <xsl:attribute-set name="pre" use-attribute-sets="base-font common.block">
        <!-- 9pt rather than the inherited 10pt: at 10pt Courier New the code
             column takes about 75 characters and the book has lines up to 80,
             so the widest diagrams wrapped. 9pt takes about 83. -->
